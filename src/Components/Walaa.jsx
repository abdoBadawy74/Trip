...
function Walaa() {
        ...
        <div className="walaa">
            ...
            <div className="row">
                    ...
                    <div className="d-flex justify-content-between align-items-start mb-4 mt-4 pt-4">
                        <div>
                            <h2 className="text-uppercase" style={{ fontWeight: 600, letterSpacing: "2px", fontSize: "24px"
                                 , color:" #42A7C3"
                                }}>All Hotels</h2>
                        </div>
                        <div>
 ...
 <div className="search container mt-5 d-flex ">
        ...
        />
        <button className="btn m-2" style={{backgroundColor: "#42A7C3" , color:"#ffff"
                                ...
                                <div className="box bg-white p-2 rounded">
                                    <div className="image p-2">
                                        {product.images.length > 0 && (
                                            <img key={product.images[0].id} src={product.images[0].url} alt={product.name} className="w-100 rounded" />
                                        )}
                                    </div>
                                    <div className="text px-2">
                                        <div className="d-flex align-items-center">
